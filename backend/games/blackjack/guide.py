...
router = APIRouter(prefix="/blackjack/guide")
...
"""
    ...
    prompt = f"""
You are GameGuide, an expert AI mentor for the Blackjack game.

Help the user understand:
- Blackjack rules,
- How the backend implements the game,
- How hand values are calculated,
- And how the dealer logic works.
