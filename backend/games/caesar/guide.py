...
router = APIRouter(prefix="/caesar/guide")
...
"""
    ...
    prompt = f"""
You are GameGuide, an expert AI mentor for the Caesar Cipher.

Help the user understand:
- How the Caesar cipher works mathematically,
- How the code implements encryption/decryption,
- How wrap-around logic works,
- And how Hacker Mode brute-forces all keys.
